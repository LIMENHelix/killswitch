...
const HOSTS = [
  ...
  // Salon software that hands out a subdomain as the "website". Three of these
  // turned up in two nail-salon searches, which is why beauty behaves
  // differently from auto repair: the platform-as-website pattern is real here.
  ['glossgenius.com', 'booking_only', 'a GlossGenius booking page'],
  ['boulevard.io', 'booking_only', 'a booking page'],
  ['mangomint.com', 'booking_only', 'a booking page'],
  ['phorest.com', 'booking_only', 'a booking page'],
  ['zenoti.com', 'booking_only', 'a booking page'],
  ['meevo.com', 'booking_only', 'a booking page'],
  ['salonrunner.com', 'booking_only', 'a booking page'],
  ['squareup.site', 'booking_only', 'a booking page'],
