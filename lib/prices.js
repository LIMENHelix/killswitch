...
// RETIRED: priced in Stripe, but NOT FOR SALE, because there is nothing behind
// them. P5 (CRM) and P6 (Marketing Automation) were listed at $29/mo each with
// five benefit bullets apiece and had no implementation anywhere in this
// codebase, so a customer could be charged $58/mo for software that was never
// written. They come back off this list the day they actually exist.
//
// RETIRING IS NOT DELETING, and the difference matters. Their price ids stay in
// MONTHLY and PRICE_TO_PHASE above so that anyone who already bought one still
// reads as entitled, still sees it in their panel, and can still switch it OFF.
// Dropping them from the maps would make a live subscription invisible to us
// while Stripe kept charging for it. What is blocked is ADDING one.
export const RETIRED = new Set(['P5', 'P6']);
