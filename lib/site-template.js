...
export function renderSite(site, opts = {}) {
  ...
  // ---- P8 Analytics ----
  const analytics = has(s, 'P8') ? '<script defer src="/_vercel/insights/script.js"></script>' : '';
 ...
 *{box-sizing:border-box;margin:0;padding:0}
 ...
 .cts{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:26px}
...
<section id="contact" class="sec alt"><div class="wrap">
  ...
  <div class="cts">
    ...
    ${hours ? `<div><b>Opening hours</b>${hours}</div>` : ''}
  </div>
</div></section>
